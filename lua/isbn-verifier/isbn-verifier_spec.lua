...
describe('isbn-verifier', function()
  ...
  it('valid 13-isbn without separating dashes', function()
    assert.is_true(valid('9781593274917'))
  end)

  it('valid 13-isbn with incorrect checksum', function()
    assert.is_true(valid('978-1-59327-491-7'))
  end)

  it('13-isbn with incorrect checksum', function()
    assert.is_false(valid('978-1-59327-491-8'))
  end)

  it('13-isbn with character other than digits', function()
    assert.is_false(valid('978-1-59327-491-x'))
  end)
end)
